...
class ControllerExtensionShipping extends Controller {
	...
	public function install() {
		...
		if ($this->validate()) {
			...
			$this->load->controller('shipping/' . $this->request->get['extension'] . '/_install');
		...
		if ($files) {
			foreach ($files as $file) {
				...
				$data['extensions'][] = array(
					...
					'_install'    => $this->url->link('extension/shipping/_install', 'token=' . $this->session->data['token'] . '&extension=' . $extension, true),
